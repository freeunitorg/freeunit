...
|------|-------|-----------|--------------|--------|
| 7976 | — | — (plain-Python upstream in the test file) | — | `test_proxy_te.py` (upstream Transfer-Encoding framing: case-insensitive `chunked`, lists, several field lines, Content-Length together with Transfer-Encoding) |
| 7977 | — | — (plain-Python upstream in the test file) | — | `test_proxy_interim.py` (the proxy drops upstream 1xx responses and sends the final one) |
