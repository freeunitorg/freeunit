...
|------|-------|-----------|--------------|--------|
| 7977 | — | — (plain-Python upstream in the test file) | — | `test_proxy_te.py` (upstream Transfer-Encoding framing: case-insensitive `chunked`, lists, several field lines, Content-Length together with Transfer-Encoding) |
...
> 7998. New `fake_upstream` slots go to the 7974–7976 gap (7977–7979 are taken above, 7980–7982 are `fake_otlp`).
